...
class TestVector:
    ...
    def test_unit(self):
        assert Point(0, 1) == Vector("U2").unit()
        assert Point(1, 0) == Vector("R3").unit()
        assert Point(0, -1) == Vector("D4").unit()
        assert Point(-1, 0) == Vector("L5").unit()

    def test_to_point(self):
        assert Point(2, 0) == Vector("R2").to_point()
...
class TestPath:
    ...
    def test_extend(self):
        p = Path()
        p.extend("R2")
        assert p.vectors == [Vector("R2")]
        p.extend("U1")
        assert p.vectors == [Vector("R2"), Vector("U1")]
