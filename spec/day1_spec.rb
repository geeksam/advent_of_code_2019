...
RSpec.describe 'fuel requirements' do
  ...
  specify "For a mass of 12, the simple fuel required is 2." do
    expect( Fuel.for_mass_simple(12) ).to eq( 2 )
  end

  specify "For a mass of 14, the simple fuel required is 2." do
    expect( Fuel.for_mass_simple(14) ).to eq( 2 )
  end

  specify "For a mass of 1969, the simple fuel required is 654." do
    expect( Fuel.for_mass_simple(1969) ).to eq( 654 )
  end

  specify "For a mass of 100756, the simple fuel required is 33583." do
  ...
  specify "For a mass of 14, the actual fuel required is 2." do
  ...
  specify "For a mass of 1969 , the actual fuel required is 2." do
  ...
  specify "For a mass of 100756, the actual fuel required is 50346 ." do
